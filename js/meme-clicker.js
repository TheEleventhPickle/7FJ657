...
game.state.add('play', {
	...
	preload: function () {
		...
		this.game.load.image('mike',   enemiesDir + 'mike.png');
		this.game.load.image('fieri',   enemiesDir + 'fieri.png');
	...
	create: function () {
		...
		var monsterData = [
		    ...
		    {name: 'guy fieri',      image: 'fieri',      maxHealth: 4},
		...
		this.currentMonster.position.set(this.game.world.centerX - 10, this.game.world.centerY + 300);
	...
	onRevivedMonster: function (monster) {
		monster.position.set(this.game.world.centerX - 10, this.game.world.centerY + 300);
